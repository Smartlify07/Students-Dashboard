...
const GradesOverview = () => {
  return (
    <Card className=" bg-white rounded-[3.5rem] flex justify-between py-[2.4rem] px-[1rem] md:px-[2.4rem] lg:w-6/12 ">
      <div className="flex flex-col gap-[3rem]  h-full  justify-between">
        ...
        <div className="flex flex-col gap-0">
          <p className="text-neutral-400 text-[1.2rem] whitespace-nowrap md:whitespace-normal md:text-[1.4rem] font-medium font-poppins">
            Grade average
          </p>
